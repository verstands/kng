...
import { SortiKinshasaJourCountSortiTs, getBalancetKinshasa, getCounrDepotKinshasa, getCounrRetraitKinshasa, getEntreJourneAllKin } from "../../actions/SortieAction";
              ...
              <View>
                <View style={styles.table}>
                  ...
                  <View style={styles.tableRow}>
                    ...
                    <View style={[styles.tableCol,  {backgroundColor : "black"}]}>
                      <Text style={[styles.tableCell, { color: "white" }]}>{countDepot}</Text>
                    </View>
                  </View>
                  <View style={styles.tableRow}>
                    <View style={[styles.tableCol, {backgroundColor : "black"}]}>
                    ...
                    <View style={[styles.tableCol,  {backgroundColor : "black"}]}>
                      <Text style={[styles.tableCell, { color: "white" }]}>{countSorti}</Text>
                    </View>
                  </View>
                  <View style={styles.tableRow}>
                    <View style={[styles.tableCol, {backgroundColor : "black"}]}>
                    ...
                    <View style={[styles.tableCol,  {backgroundColor : "black"}]}>
                      <Text style={[styles.tableCell, { color: "white" }]}>{countTS}</Text>
                    </View>
                  </View>
                  <View style={styles.tableRow}>
                    <View style={[styles.tableCol, {backgroundColor : "black"}]}>
